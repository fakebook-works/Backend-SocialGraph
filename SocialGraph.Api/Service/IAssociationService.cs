...
public interface IAssociationService
{
    ...
    Task<bool> LeaveGroupWithAdminTransferAsync(long userId, long groupId, CancellationToken cancellationToken = default);
    Task<bool> RemoveGroupMemberByAdminAsync(long adminId, long userId, long groupId, CancellationToken cancellationToken = default);
    Task<bool> DemoteGroupAdminAsync(long userId, long groupId, CancellationToken cancellationToken = default);
